...
public sealed class CourseChoiceDraftCourseItemTests
{
    ...
    public void NewDraftStartsEveryScheduledOfferingAsAcceptable()
    {
        ...
        CourseChoiceDraftCourseItem draft = CourseChoiceDraftCourseItem.CreateNew(course);
    ...
    public void RestoredDraftPreservesSavedPreferenceAndExcludesNewOffering()
    {
        ...
        CourseChoiceDraftCourseItem draft = CourseChoiceDraftCourseItem.Restore(course, savedCandidates);
    ...
    {
        CourseCatalogProjection catalog = CourseCatalogProjector.Project(CatalogProjectionTestFixture.CreateDocument());
        ...
        Assert.All(
            ...
            offering =>
            {
                Assert.False(offering.Projection.Offering.MeetingSchedule.IsScheduled);
    ...
    public void TimeNotProvidedCourseCanBePresentedAsAnAlternative()
    {
        ...
        CourseChoiceAlternativeSearchItem searchItem = new CourseChoiceAlternativeSearchItem(course);
