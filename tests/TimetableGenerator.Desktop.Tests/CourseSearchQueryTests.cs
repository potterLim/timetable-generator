...
public sealed class CourseSearchQueryTests
{
    ...
    {
        CourseSearchQuery koreanTitleQuery = CourseSearchQuery.Create(
            "컴 퓨 터\u202F구 조");
        CourseSearchQuery courseCodeQuery = CourseSearchQuery.Create(
            "e c e 2 0 0 2 1");
    ...
    public void SearchKeepsOrderSpellingAndPunctuationSignificant()
    {
        ...
        CourseSearchQuery reorderedQuery = CourseSearchQuery.Create(
            "Architecture Computer");
        CourseSearchQuery punctuationQuery = CourseSearchQuery.Create(
            "Computer-Architecture");
