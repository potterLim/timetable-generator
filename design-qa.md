...
- 시간표는 월–금과 7교시 종료 시각을 기본 범위로 사용하고, 일정에 따라 토요일·일요일과 더 이르거나 늦은 시각까지 확장한다. 왼쪽 축과 가로 안내선은 교시가 아닌 30분 단위 실제 시각을 사용한다.
...
9. 동적 시간표 범위 — 해결: 주말과 기본 범위 밖의 일정을 보존하면서 30분 실제 시간 축을 자동 확장한다.
