...
- 삭제 취소
- 삭제 확인
- 추가·수정 중 시간표 구성 패널이 이유 없이 닫히지 않는지
- 시간표 구성 패널은 X 등 명시된 동작에서만 닫히는지
...
- 1600 DIP 이상: 과목 패널 312 + 시간표 구성 288 inline
- 1280–1599: 과목 inline, 시간표 구성 304 overlay
- 1080–1279: 과목 inline 약 320, 시간표 구성 overlay
- 1080 미만: 양쪽 overlay
...
- 시간표 구성 열기
- 두 패널의 compact 상호 배제
- 시간표 구성을 열고 일정 추가·수정·과목 수정을 해도 패널이 임의로 닫히지 않는지
