...
internal sealed class DuplicateCourseOfferingException : Exception
{
    ...
    public DuplicateCourseOfferingException(
        CourseOfferingKey offeringKey,
        SourceRecordNumber firstSourceRecordNumber,
        SourceRecordNumber duplicateSourceRecordNumber)
        : base(createMessage(
            offeringKey,
            firstSourceRecordNumber,
            duplicateSourceRecordNumber))
    {
    ...
    private static string createMessage(
        ...
        SourceRecordNumber duplicateSourceRecordNumber)
    {
        return "Offering " + offeringKey.CourseCode + ":" + offeringKey.SectionCode +
            " is duplicated at source records " + firstSourceRecordNumber +
            " and " + duplicateSourceRecordNumber + ".";
    }
}
