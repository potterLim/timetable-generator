...
.EXAMPLE
pwsh ./scripts/finalize-desktop-release.ps1 -Stage Windows -Version 1.0.1
...
pwsh ./scripts/finalize-desktop-release.ps1 -Stage MacOS -Runtime osx-arm64 `
  -Version 1.0.1 -BundleIdentifier io.github.potterlim.timetable

.EXAMPLE
pwsh ./scripts/finalize-desktop-release.ps1 -Stage Aggregate -Version 1.0.1 `
  -WindowsSignatureMode Unsigned
#>
