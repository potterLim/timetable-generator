...
- 좁은 창에서도 과목 찾기와 시간표 관리 패널을 열고 닫을 수 있는 반응형 Avalonia UI
- 현재 시간표의 수업과 개인 일정에 맞춰 가장 이른 일정이 속한 정각 30분 전부터 마지막 일정 종료 시각보다 늦은 첫 정각까지 표시하고, 빈 시간표에는 시간축 대신 빈 상태를 제공하는 실제 시간 축
